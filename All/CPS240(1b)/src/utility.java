...
public class utility {
	...
	public static List<Integer> genList(int n) {
		...
		Random r = new Random(); 				//Declares a new random object
	...
	public static List<Integer> selectionSort(List<Integer> newList) {
		...
		for (int i = 0; i < newList.size()-1; i++) { 	//Loop throught the entirety of the List
	...
	public static List<Integer> removeDuplicates(List<Integer> newList) {
