...
public class tryagain {
	...
	public static void main(String[] args) {
		...
		while (watcher < 9) { // The number of turns one is able to take is 9
			...
			System.out.println("Make a choice!"); // prompts the player to make
													// a choice
				...
				if (turnofPlayer.equals("a3")) {
					...
					if (turnofPlayer.equals("b1")) {
						if (b1 == " ") {
							...
							b1 = input.next(); // Prints out the code in the
												// case
												// that block is already taken
						} else {
							// Creates an if/else statement that allows the user
							// to
							// choose which point they'd like to start in.
							if (b1 != " ") {
								System.out
					...
					if (turnofPlayer.equals("b3")) {
						...
						if (turnofPlayer.equals("c1")) {
							if (c1 == " ") {
								...
								c1 = input.next(); // Prints out the code in the
													// case
													// that block is already taken
							} else {
								// Creates an if/else statement that allows the user
